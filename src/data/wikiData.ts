...
export const wikiSections: WikiSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        category: "Realm",
        title: "Travel",
        summary: "Travel owns routes, destinations, departure, travel time, risk, cargo relevance, and encounter relevance. Departure uses real transport tiers, each with its own cargo capacity, gold cost, and escort cost.",
        routes: [{ label: "Travel", to: "/travel" }],
        rules: ["World Map does not start travel.", "Route gates should explain requirements.", "World Geography improves efficient travel and discovery.", "Higher transport tiers cost more gold but carry more cargo and support hired escorts."],
      },
      {
        id: "world-map",
        category: "Realm",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        category: "Combat and PvP",
        title: "PvP Modes",
        summary: "Arena duels are the only PvP path live today. Sparring, ranked duels, guild rivalry scoring, caravan danger routes, and arena seasons exist server-side as a PvP foundation, but none of them have a player-facing page yet.",
        routes: [{ label: "Arena", to: "/arena" }, { label: "Guilds", to: "/guilds" }, { label: "Consortiums", to: "/consortiums" }],
        rules: ["Arena duels remain the active player combat route right now.", "Sparring, ranked duels, guild rivalry scoring, caravan interception, and arena seasons have no live page to start them from yet.", "PvP will start protected by default once a mode goes live.", "Bounty writs stay inactive until live operations explicitly enables them."],
      },
      {
        id: "notoriety",
        category: "Combat and PvP",
    ...
    entries: [
      {
        ...
        title: "Guilds",
        summary: "Guilds are factions and operations hubs for combat, expeditions, rivalry, armory, base upgrades, prestige, and assistance work. Charter Doctrine is the guild skill tree: every founded guild keeps two free Core Doctrine bonuses, plus a capped set of active specializations chosen from the guild's full unlocked list.",
        routes: [{ label: "Guilds", to: "/guilds" }],
        rules: ["Guilds are not companies.", "First view should show who you are, what you gain, what is active, and what to do next.", "Operations should feel like adventures and field work.", "Only 3 specializations can be active at once; swapping an active slot costs treasury gold, so it stays a real decision."],
      },
      {
        id: "consortiums",
        category: "Organizations",
        title: "Consortiums",
        summary: "Consortiums are player companies for logistics, treasury, routes, staff, finance, assets, and advancement. Each of the 12 consortium types has its own star-tier reward ladder: server-computed passive and active perks that unlock as the company's star rating climbs.",
        routes: [{ label: "Consortiums", to: "/consortiums" }],
        rules: ["Consortiums are not guilds.", "Company type, rank, passives, hazard, and next steps should be visible.", "Treasury and route outcomes should matter.", "Star rating is computed from staffing, roles filled, and treasury discipline, not flavor text."],
      },
      {
        id: "assistance-loops",
        category: "Organizations",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        category: "Adventure and Discovery",
        title: "City Diaries",
        summary: "City diaries define Easy, Standard, Dangerous, and Elite checklists for each launch city, with compact progress and identity rewards. This is a data foundation today: no page yet renders a diary checklist for players.",
        routes: [{ label: "World Map", to: "/world-map" }, { label: "City", to: "/city" }],
        rules: ["Nexis City, Blackharbor, Silverbough, Ironhall, and Highcourt each have their own diary identity.", "Diary progress should connect to discoveries, one-shots, contracts, and organization work once a checklist page exists.", "Rewards should be earned, not prefilled.", "Treat this entry as foundation, not a live checklist you can open yet."],
      },
      {
        id: "world-events",
        category: "Adventure and Discovery",
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "inactive-systems", category: "Operations and Safety", title: "Inactive Systems", summary: "Some foundations can exist before full UI launch, but mutation routes stay locked and pages should say plainly when a system is foundation-only rather than implying it is already playable.", routes: [{ label: "Wiki", to: "/wiki" }, { label: "Arena", to: "/arena" }], rules: ["PvP bounty writs are inactive unless live operations enables them.", "Sparring, ranked duels, guild rivalry scoring, caravan interception, and arena seasons are foundation-only; Arena duels remain the live PvP path.", "City diary checklists and world-progression quality tracking exist as a data foundation with no player-facing checklist page yet.", "Inactive systems should not spend gold, grant rewards, or expose private state.", "Wiki copy must not pretend inactive systems are fully playable."], related: ["pvp-foundation", "city-diaries", "server-authority"] },
