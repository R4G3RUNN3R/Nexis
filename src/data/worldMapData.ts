...
export const worldRoutes: WorldRoute[] = [
  ...
  },
  {
    ...
    type: "road",
    status: "fully_wired",
    travelLabel: "Highland forge trade road",
    rule: "Overland route through mountain passes and relic-material convoys linking Silverbough's arcane trade to Ironhall's foundries.",
  },
  {
    ...
    type: "road",
    status: "fully_wired",
    travelLabel: "Silverbough-Highcourt permit road",
    rule: "Long overland route through northern roads and court permit checkpoints.",
  },
  {
    id: "route_north_west",
    from: "north",
    ...
    type: "sea",
    status: "fully_wired",
    travelLabel: "Warded woods sea lane",
    rule: "Sea lane out past the warded northern coast into Blackharbor's harbor.",
  },
  {
    id: "route_west_east",
    from: "west",
    ...
    type: "mixed",
    status: "fully_wired",
    travelLabel: "Blackharbor-Ironhall convoy route",
    rule: "Mixed sea-and-road route carrying material convoys between Blackharbor's docks and Ironhall's forge road.",
  },
  {
    id: "route_west_south",
    from: "west",
    ...
    type: "sea",
    status: "fully_wired",
    travelLabel: "Legal cargo lane",
    rule: "Regulated sea cargo lane through privateer-watched waters between Blackharbor and Highcourt.",
  },
];
