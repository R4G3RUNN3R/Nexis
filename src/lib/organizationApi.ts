...
export const inviteConsortiumMember = (token: string, organizationInternalId: string, publicId: string) => requestJson<{ organization: ConsortiumBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/consortiums/invites`, token, { method: "POST", body: JSON.stringify({ publicId }) });
export const respondToConsortiumInvite = (token: string, organizationInternalId: string, decision: "accept" | "decline") => requestJson<{ organization: ConsortiumBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/consortiums/invites/respond`, token, { method: "POST", body: JSON.stringify({ decision }) });
...
export const updateConsortiumSettings = (token: string, organizationInternalId: string, payload: Record<string, unknown>) => requestJson<{ organization: ConsortiumBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/consortiums/settings`, token, { method: "POST", body: JSON.stringify(payload) });
...
export const applyToGuild = (token: string, organizationInternalId: string, note: string) => requestJson<{ ok: true }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/guilds/apply`, token, { method: "POST", body: JSON.stringify({ note }) });
export const reviewGuildApplication = (token: string, organizationInternalId: string, applicantPublicId: string, decision: "accept" | "reject") => requestJson<{ organization: GuildBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/guilds/applications/review`, token, { method: "POST", body: JSON.stringify({ applicantPublicId, decision }) });
export const inviteGuildMember = (token: string, organizationInternalId: string, publicId: string) => requestJson<{ organization: GuildBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/guilds/invites`, token, { method: "POST", body: JSON.stringify({ publicId }) });
export const respondToGuildInvite = (token: string, organizationInternalId: string, decision: "accept" | "decline") => requestJson<{ organization: GuildBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/guilds/invites/respond`, token, { method: "POST", body: JSON.stringify({ decision }) });
...
export const swapGuildSkill = (token: string, organizationInternalId: string, activateKey: string, deactivateKey: string) => requestJson<{ organization: GuildBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/guilds/skills/swap`, token, { method: "POST", body: JSON.stringify({ activateKey, deactivateKey }) });
export const triggerGuildRally = (token: string, organizationInternalId: string) => requestJson<{ organization: GuildBoard }>(`/api/organizations/${encodeURIComponent(organizationInternalId)}/guilds/rally`, token, { method: "POST" });
