// ─────────────────────────────────────────────────────────────────────────────
// Nexis — Life Paths data
// Soft, early-game identity lanes per the Nexis Game Master Plan (§8): not
// classes, not permanent prisons. They flavor tutorial/early text and point
// new citizens at a starting job and education branch. Nothing here gates
// mechanical progression — every job and course stays reachable regardless
// of the chosen path.
// ─────────────────────────────────────────────────────────────────────────────
...
export const LIFE_PATHS = [
  {
    ...
    suggestedJob: {
      label: "Beginner Adventurer",
      system: "adventure",
      systemId: "beginner_adventurer",
      route: "/adventure",
    },
    suggestedEducation: {
  ...
  },
  {
    ...
    suggestedEducation: {
      label: "Back Alley Awareness",
      categoryId: "street",
      categoryLabel: "Street Survival",
      courseId: "back-alley-awareness",
      route: "/education",
    },
  ...
  },
  {
    ...
    suggestedEducation: {
      label: "Sigil Literacy",
      categoryId: "arcane",
      categoryLabel: "Arcane Studies",
      courseId: "sigil-literacy",
      route: "/education",
    },
  ...
  },
  {
    ...
    suggestedEducation: {
      label: "Ledger Basics",
      categoryId: "trade",
      categoryLabel: "Commerce & Trade / Economics",
      courseId: "ledger-basics",
      route: "/education",
    },
  ...
  },
  {
    ...
    suggestedJob: {
      label: "Apothecary Hall",
      system: "civic",
      systemId: "apothecary_hall",
      route: "/civic-jobs",
    },
    suggestedEducation: {
      label: "Field Triage",
      categoryId: "medicine",
      categoryLabel: "Medical & Biology",
      courseId: "field-triage",
      route: "/education",
    },
  ...
  },
  {
    ...
    suggestedJob: {
      ...
      system: "civic",
      systemId: "builders_guild",
      route: "/civic-jobs",
    },
    suggestedEducation: {
      label: "Tool Use Foundations",
      categoryId: "craftsmanship",
      categoryLabel: "Craftsmanship & Artifice",
      courseId: "tool-use-foundations",
      route: "/education",
    },
...
export const LIFE_PATH_IDS = new Set(LIFE_PATHS.map((path) => path.id));

export function getLifePath(lifePathId) {
  return LIFE_PATHS.find((path) => path.id === lifePathId) ?? null;
}

export function isValidLifePathId(lifePathId) {
  return typeof lifePathId === "string" && LIFE_PATH_IDS.has(lifePathId);
}
