...
export const educationCategories = [
  ...
  },
  {
    id: "selfdefense",
    name: "Self Defense",
    description: "Practical personal safety for citizens who never intend to pick a fight but refuse to lose one they didn't start.",
    courses: [
      makeCourse("selfdefense", 1, {
        id: "threat-awareness",
        name: "Threat Awareness",
        durationDays: 8,
        costGold: 700,
        description: "Reading a room, a street, or a stranger before trouble finishes reading you.",
        rewardKind: "combat",
        workingStatRewards: { intelligence: 1 },
        systemEffects: ["Ambush avoidance +5%"],
        summaryLines: ["Ambush avoidance +5%", "Intelligence +1", "Foundational personal safety course"],
      }),
      makeCourse("selfdefense", 2, {
        id: "basic-blocking",
        name: "Basic Blocking",
        durationDays: 10,
        costGold: 1000,
        description: "Guards, blocks, and absorbing a hit without forgetting how to stand.",
        rewardKind: "combat",
        prerequisites: ["threat-awareness"],
        statRewards: { defense: 2 },
        systemEffects: ["Damage taken in street encounters -3%"],
        summaryLines: ["Damage taken in street encounters -3%", "Defense +2"],
      }),
      makeCourse("selfdefense", 3, {
        id: "improvised-defense",
        name: "Improvised Defense",
        durationDays: 12,
        costGold: 1300,
        description: "Chairs, bottles, and whatever else is within reach when talking stops working.",
        rewardKind: "combat",
        prerequisites: ["basic-blocking"],
        statRewards: { strength: 1 },
        workingStatRewards: { manualLabor: 1 },
        systemEffects: ["Unarmed and improvised damage +5%"],
        summaryLines: ["Unarmed and improvised damage +5%", "Strength +1, Manual Labor +1"],
      }),
      makeCourse("selfdefense", 4, {
        id: "de-escalation-tactics",
        name: "De-escalation Tactics",
        durationDays: 13,
        costGold: 1600,
        description: "Talking a bad situation down before it becomes a worse one, and recognizing the moment that stops being possible.",
        rewardKind: "utility",
        prerequisites: ["improvised-defense"],
        workingStatRewards: { intelligence: 2 },
        systemEffects: ["Mugging and ambush encounter success +5%"],
        summaryLines: ["Mugging and ambush encounter success +5%", "Intelligence +2"],
      }),
      makeCourse("selfdefense", 5, {
        id: "self-defense-mastery",
        name: "Self Defense Mastery",
        durationDays: 18,
        costGold: 2600,
        description: "A capstone for citizens who never wanted to be fighters, and can now handle it anyway.",
        rewardKind: "combat",
        prerequisites: ["threat-awareness", "basic-blocking", "improvised-defense", "de-escalation-tactics"],
        statRewards: { defense: 2, speed: 1 },
        systemEffects: ["All battle stats +3%"],
        unlocksSystems: ["self_defense_mastery"],
        summaryLines: ["All battle stats +3%", "Defense +2, Speed +1", "Requires all previous Self Defense courses"],
      }),
    ],
  },
  {
  ...
  },
  {
    id: "shadowcraft",
    name: "Shadowcraft",
    description: "Academy-bound blade-and-shadow tradecraft. Locked behind Street Survival mastery -- the underworld baseline this branch was always meant to complete.",
    courses: [
      makeCourse("shadowcraft", 1, { id: "shadow-footwork", name: "Shadow Footwork", durationDays: 11, costGold: 1700, description: "Silent movement, weight control, and blade-ready stance for corridors, alleys, and cargo holds too tight for open-field drilling.", rewardKind: "shadow", prerequisites: ["streetwise-mastery"], statRewards: { speed: 1 }, systemEffects: ["Shadowcraft progress +5%", "Stealth movement +3%"], summaryLines: ["Stealth movement +3%", "Speed +1", "Unlocked by completing Street Survival"] }),
      makeCourse("shadowcraft", 2, { id: "silent-strike-form", name: "Silent Strike Form", durationDays: 13, costGold: 2200, description: "Fast, quiet openings meant to end an engagement before the target realizes it started.", rewardKind: "shadow", prerequisites: ["shadow-footwork"], statRewards: { dexterity: 1 }, systemEffects: ["Shadowcraft progress +5%", "Sneak attack damage +3%"], summaryLines: ["Sneak attack damage +3%", "Dexterity +1"] }),
      makeCourse("shadowcraft", 3, { id: "shadow-blade-drills", name: "Shadow Blade Drills", durationDays: 15, costGold: 2700, description: "Close-quarters blade work built around bad lighting, worse footing, and no room to retreat.", rewardKind: "shadow", prerequisites: ["silent-strike-form"], statRewards: { dexterity: 1, speed: 1 }, systemEffects: ["Shadowcraft progress +5%"], summaryLines: ["Dexterity +1, Speed +1", "Supports Western Academy specialization paths"] }),
      makeCourse("shadowcraft", 4, { id: "shadowcraft-mastery", name: "Shadowcraft Mastery", durationDays: 17, costGold: 3200, description: "Full command of blade-and-shadow tradecraft -- the Western Academy's answer to what Street Survival started.", rewardKind: "shadow", prerequisites: ["shadow-blade-drills"], statRewards: { dexterity: 2 }, systemEffects: ["Shadowcraft progress +5%", "Unlocks Western Academy Shadowcraft specialization"], unlocksSystems: ["shadowcraft_specialization"], summaryLines: ["Dexterity +2", "Unlocks Western Academy Shadowcraft specialization", "Shadowcraft capstone"] }),
    ],
  },
  {
    id: "ranged",
    ...
    courses: [
      makeCourse("ranged", 1, { id: "range-sighting", name: "Range Sighting", durationDays: 11, costGold: 1700, description: "Judging wind, drop, and distance before committing to a shot.", rewardKind: "combat", prerequisites: ["drill-square-basics"], workingStatRewards: { endurance: 1 }, systemEffects: ["Ranged Arts progress +5%", "Ranged accuracy +3%"], summaryLines: ["Ranged accuracy +3%", "Endurance +1"] }),
      makeCourse("ranged", 2, { id: "draw-discipline", name: "Draw Discipline", durationDays: 13, costGold: 2200, description: "Steady draw weight and release timing that hold up under a moving target and a shaking hand.", rewardKind: "combat", prerequisites: ["range-sighting"], workingStatRewards: { endurance: 1 }, systemEffects: ["Ranged Arts progress +5%", "Draw speed +3%"], summaryLines: ["Draw speed +3%", "Endurance +1"] }),
      makeCourse("ranged", 3, { id: "volley-coordination", name: "Volley Coordination", durationDays: 15, costGold: 2700, description: "Timing coordinated fire with a crew so nobody's arrow lands on somebody else's.", rewardKind: "combat", prerequisites: ["draw-discipline"], workingStatRewards: { endurance: 1 }, systemEffects: ["Ranged Arts progress +5%", "Group ranged accuracy +3%"], summaryLines: ["Group ranged accuracy +3%", "Endurance +1"] }),
      makeCourse("ranged", 4, { id: "ranged-mastery", name: "Ranged Mastery", durationDays: 17, costGold: 3200, description: "Full command of bows, crossbows, and thrown tools across moving, hostile ground.", rewardKind: "combat", prerequisites: ["volley-coordination"], workingStatRewards: { endurance: 1 }, systemEffects: ["Ranged Arts progress +5%", "Critical shot chance +3%"], summaryLines: ["Critical shot chance +3%", "Endurance +1", "Ranged Arts capstone"] }),
    ],
  },
  {
    id: "arcane",
    ...
    courses: [
      makeCourse("arcane", 1, { id: "sigil-literacy", name: "Sigil Literacy", durationDays: 11, costGold: 1700, description: "Reading warded inscriptions without triggering the ones that bite back.", rewardKind: "utility", prerequisites: ["basic-literacy"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Arcane Studies progress +5%", "Ward misread chance -5%"], summaryLines: ["Ward misread chance -5%", "Intelligence +1, Endurance +1"] }),
      makeCourse("arcane", 2, { id: "focus-handling", name: "Focus Handling", durationDays: 13, costGold: 2200, description: "Steadying a focus object under pressure so channeling doesn't fray at the worst moment.", rewardKind: "utility", prerequisites: ["sigil-literacy"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Arcane Studies progress +5%", "Channel stability +3%"], summaryLines: ["Channel stability +3%", "Intelligence +1, Endurance +1"] }),
      makeCourse("arcane", 3, { id: "ward-geometry", name: "Ward Geometry", durationDays: 15, costGold: 2700, description: "Mapping ward lattices onto real terrain to find the seams safe to cross.", rewardKind: "utility", prerequisites: ["focus-handling", "world-geography"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Arcane Studies progress +5%", "Ward navigation success +5%"], summaryLines: ["Ward navigation success +5%", "Intelligence +1, Endurance +1"] }),
      makeCourse("arcane", 4, { id: "arcane-mastery", name: "Arcane Mastery", durationDays: 17, costGold: 3200, description: "Relic-safe channeling at full strength, with the discipline not to unmake yourself doing it.", rewardKind: "utility", prerequisites: ["ward-geometry", "historical-awareness"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Arcane Studies progress +5%", "Relic handling safety +5%"], summaryLines: ["Relic handling safety +5%", "Intelligence +1, Endurance +1", "Arcane Studies capstone"] }),
    ],
  },
  {
    id: "craftsmanship",
    ...
    courses: [
      makeCourse("craftsmanship", 1, { id: "tool-use-foundations", name: "Tool Use Foundations", durationDays: 11, costGold: 1700, description: "Holding, maintaining, and actually using the tools instead of just owning them.", rewardKind: "economy", prerequisites: ["practical-arithmetic"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Craftsmanship progress +5%", "Tool wear -3%"], summaryLines: ["Tool wear -3%", "Intelligence +1, Endurance +1"] }),
      makeCourse("craftsmanship", 2, { id: "material-sorting", name: "Material Sorting", durationDays: 13, costGold: 2200, description: "Grading salvage and stock by quality instead of guessing and hoping.", rewardKind: "economy", prerequisites: ["tool-use-foundations"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Craftsmanship progress +5%", "Material yield +3%"], summaryLines: ["Material yield +3%", "Intelligence +1, Endurance +1"] }),
      makeCourse("craftsmanship", 3, { id: "repair-discipline", name: "Repair Discipline", durationDays: 15, costGold: 2700, description: "Fixing gear properly the first time so it doesn't fail somewhere worse.", rewardKind: "economy", prerequisites: ["material-sorting"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Craftsmanship progress +5%", "Repair success +5%"], summaryLines: ["Repair success +5%", "Intelligence +1, Endurance +1"] }),
      makeCourse("craftsmanship", 4, { id: "artifice-mastery", name: "Artifice Mastery", durationDays: 17, costGold: 3200, description: "Building and modifying mechanisms that hold up outside a workshop.", rewardKind: "economy", prerequisites: ["repair-discipline", "applied-ledgers"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Craftsmanship progress +5%", "Crafted item quality +5%"], summaryLines: ["Crafted item quality +5%", "Intelligence +1, Endurance +1", "Craftsmanship capstone"] }),
    ],
  },
  {
    id: "diplomacy",
    ...
    courses: [
      makeCourse("diplomacy", 1, { id: "formal-address", name: "Formal Address", durationDays: 11, costGold: 1700, description: "Titles, protocol, and the correct way to ask a noble for something without insulting their house.", rewardKind: "governance", prerequisites: ["civic-fundamentals"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Diplomacy progress +5%", "Formal audience success +3%"], summaryLines: ["Formal audience success +3%", "Intelligence +1, Endurance +1"] }),
      makeCourse("diplomacy", 2, { id: "negotiated-access", name: "Negotiated Access", durationDays: 13, costGold: 2200, description: "Turning a closed door into an appointment, and an appointment into terms worth having.", rewardKind: "governance", prerequisites: ["formal-address"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Diplomacy progress +5%", "Negotiated pricing +3%"], summaryLines: ["Negotiated pricing +3%", "Intelligence +1, Endurance +1"] }),
      makeCourse("diplomacy", 3, { id: "envoy-practice", name: "Envoy Practice", durationDays: 15, costGold: 2700, description: "Carrying a city's voice into someone else's territory without starting a war by accident.", rewardKind: "governance", prerequisites: ["negotiated-access", "world-geography"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Diplomacy progress +5%", "Cross-city standing +3%"], summaryLines: ["Cross-city standing +3%", "Intelligence +1, Endurance +1"] }),
      makeCourse("diplomacy", 4, { id: "diplomacy-mastery", name: "Diplomacy Mastery", durationDays: 17, costGold: 3200, description: "Full command of the negotiating table, the formal record, and the room's temperature.", rewardKind: "governance", prerequisites: ["envoy-practice", "influence-mastery"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Diplomacy progress +5%", "Treaty and contract terms +5%"], summaryLines: ["Treaty and contract terms +5%", "Intelligence +1, Endurance +1", "Diplomacy capstone"] }),
    ],
  },
  {
    id: "maritime",
    ...
    courses: [
      makeCourse("maritime", 1, { id: "dock-procedure", name: "Dock Procedure", durationDays: 11, costGold: 1700, description: "Berth assignments, tide windows, and not getting a longshoreman's hook through your boot.", rewardKind: "travel", prerequisites: ["world-geography"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Maritime Training progress +5%", "Dock delay chance -3%"], summaryLines: ["Dock delay chance -3%", "Intelligence +1, Endurance +1"] }),
      makeCourse("maritime", 2, { id: "manifest-reading", name: "Manifest Reading", durationDays: 13, costGold: 2200, description: "Catching a shorted or falsified cargo manifest before it becomes your problem at sea.", rewardKind: "travel", prerequisites: ["dock-procedure", "practical-arithmetic"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Maritime Training progress +5%", "Cargo discrepancy detection +5%"], summaryLines: ["Cargo discrepancy detection +5%", "Intelligence +1, Endurance +1"] }),
      makeCourse("maritime", 3, { id: "escort-lanes", name: "Escort Lanes", durationDays: 15, costGold: 2700, description: "Reading privateer pressure and choosing lanes that don't end in a boarding.", rewardKind: "travel", prerequisites: ["manifest-reading"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Maritime Training progress +5%", "Sea lane hazard -5%"], summaryLines: ["Sea lane hazard -5%", "Intelligence +1, Endurance +1"] }),
      makeCourse("maritime", 4, { id: "maritime-mastery", name: "Maritime Mastery", durationDays: 17, costGold: 3200, description: "Full command of ports, tides, and escort lanes from Nexis to Blackharbor and back.", rewardKind: "travel", prerequisites: ["escort-lanes", "route-surveying"], workingStatRewards: { intelligence: 1, endurance: 1 }, systemEffects: ["Maritime Training progress +5%", "Sea route travel time -5%"], summaryLines: ["Sea route travel time -5%", "Intelligence +1, Endurance +1", "Maritime Training capstone"] }),
    ],
  }
];
