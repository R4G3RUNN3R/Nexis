...
export const ADVENTURE_DEFINITIONS = [
  ...
  {
    id: "nexis_raider_captain_response",
    cityId: "nexis",
    category: "elite_hunt",
    title: "Raider Captain Response",
    summary: "Put down the Tunnel Raider Captain before the tunnel crews finish mustering into something worse.",
    riskBand: "Elite",
    threatType: "Slashing and numbers",
    recommendedPrep: ["Nexis Watch armor", "Slashing reduction", "Heavy weapon"],
    rewardCategory: "watch command gear and registry materials",
    sourceLabel: "Registry emergency notice",
    acquisition: ["Elite Hunt", "World Event", "Guild operation"],
    opponent: foe("tunnel_raider_captain", "Tunnel Raider Captain", 6, 190, { strength: 22, defense: 17, speed: 15, dexterity: 16 }, "Slashing", "A raider captain who has finally mustered the tunnel crews into something that looks like an army."),
    reward: { gold: 184, experience: 140, items: [{ itemId: "watch_brigandine", quantity: 1 }] },
    extraDrops: [{ itemId: "ordered_steel_baton", quantity: 1 }, { itemId: "registry_glass_index", quantity: 1 }],
    gearHint: "Heavy slashing protection and a strong single-target weapon matter against the captain's honor guard.",
  },
  {
    id: "west_corsair_chief_response",
    cityId: "west",
    category: "elite_hunt",
    title: "Corsair Chief Response",
    summary: "Break the Shadow Coast Corsair Chief's fleet muster before the piers go fully dark.",
    riskBand: "Elite",
    threatType: "Piercing and poison pressure",
    recommendedPrep: ["Blackharbor Corsair set", "Bitter Antidote", "Fast accurate weapon"],
    rewardCategory: "corsair command gear and salt-forged materials",
    sourceLabel: "Dock broker emergency notice",
    acquisition: ["Elite Hunt", "World Event", "Guild operation"],
    opponent: foe("shadow_coast_corsair_chief", "Shadow Coast Corsair Chief", 6, 192, { strength: 20, defense: 16, speed: 19, dexterity: 20 }, "Piercing", "A corsair chief running a full fleet muster against the piers."),
    reward: { gold: 184, experience: 140, items: [{ itemId: "salthook_polearm", quantity: 1 }] },
    extraDrops: [{ itemId: "corsair_bandana", quantity: 1 }, { itemId: "saltsteel_binding", quantity: 1 }],
    gearHint: "Speed and piercing accuracy matter more than raw armor against the chief's boarding crew.",
  },
  {
    id: "north_grove_guardian_response",
    cityId: "north",
    category: "elite_hunt",
    title: "Grove Guardian Response",
    summary: "Contain the ward-drake loosed from the Grove Guardian's failed bindings before the wardline collapses entirely.",
    riskBand: "Elite",
    threatType: "Magical bursts",
    recommendedPrep: ["Silverbough Warden set", "Major Healing Draught", "Magical reduction"],
    rewardCategory: "relic-grade wardglass and grove materials",
    sourceLabel: "Hospice emergency notice",
    acquisition: ["Elite Hunt", "World Event", "Guild operation"],
    opponent: foe("ward_broken_grove_guardian", "Ward-Broken Grove Guardian", 7, 210, { strength: 19, defense: 20, speed: 14, dexterity: 15 }, "Magical", "A grove guardian whose bindings finally failed, now moving like something far older and angrier than a warden."),
    reward: { gold: 210, experience: 164, items: [{ itemId: "relicglass_rod", quantity: 1 }] },
    extraDrops: [{ itemId: "wardglass_splinter", quantity: 1 }, { itemId: "moonward_core", quantity: 1 }],
    gearHint: "Magical protection and strong healing are the difference between a wardfall and a funeral.",
  },
  {
    id: "south_court_champion_response",
    cityId: "south",
    category: "elite_hunt",
    title: "Court Champion Response",
    summary: "Put down the Court Champion Elite before its broken binding turns a formal duel into a riot.",
    riskBand: "Elite",
    threatType: "Piercing duelist pressure",
    recommendedPrep: ["Highcourt Bastion set", "Piercing reduction", "Accurate blade"],
    rewardCategory: "bastion command gear and court relics",
    sourceLabel: "Court emergency notice",
    acquisition: ["Elite Hunt", "World Event", "Guild operation"],
    opponent: foe("court_champion_elite", "Court Champion Elite", 6, 188, { strength: 18, defense: 19, speed: 18, dexterity: 19 }, "Piercing", "A bound champion construct that broke its formal binding and no longer recognizes the court's authority."),
    reward: { gold: 184, experience: 140, items: [{ itemId: "edict_blade", quantity: 1 }] },
    extraDrops: [{ itemId: "sealbound_gloves", quantity: 1 }],
    gearHint: "Piercing protection and accuracy matter against the champion's disciplined duelist form.",
  },
];
