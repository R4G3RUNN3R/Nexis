...
const EXTRA_ITEMS = [
  ...
  defineItem({ id: "worn_caravan_seal", displayName: "Worn Caravan Seal", category: "Trade Good", subtype: "Caravan Token", rarity: "uncommon", valueBuy: 96, valueSell: 42, cityBias: "blackharbor", legalMarketAvailability: [], blackMarketAvailability: [], marketEligible: false, shortDescription: "A weathered caravan seal recovered from wreckage on the Abandoned Road. Smuggler gatekeepers still honor the stamp.", flavorText: "The wax is cracked and the ribbon is gone, but the mark underneath still opens doors nobody admits exist.", sourceTags: ["caravan", "smuggling", "key-item"], dropFamilies: ["abandoned_road"] }),
...
const INSPIRATION_PASS_ITEMS = [

  defineItem({ id: "bonded_spice_crate", displayName: "Bonded Spice Crate", category: "Trade Good", subtype: "High-Value Cargo", rarity: "uncommon", valueBuy: 240, valueSell: 110, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: ["blackharbor", "highcourt"], shortDescription: "A sealed crate of imported spices for high-value trade runs.", flavorText: "Bond papers sit under the lid in a waxed sleeve.", sourceTags: ["trade", "cargo", "market"] }),
  defineItem({ id: "court_silk_bolt", displayName: "Court Silk Bolt", category: "Trade Good", subtype: "Luxury Cargo", rarity: "rare", valueBuy: 420, valueSell: 195, cityBias: "highcourt", sourceCity: "highcourt", legalMarketAvailability: ["highcourt"], shortDescription: "Fine silk traded through court brokers and prestige buyers.", flavorText: "Folded around cedar sticks and sealed in pale cord.", sourceTags: ["trade", "luxury"] }),
  defineItem({ id: "ironhall_bearing_lot", displayName: "Ironhall Bearing Lot", category: "Trade Good", subtype: "Industrial Lot", rarity: "uncommon", valueBuy: 260, valueSell: 120, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall", "nexis"], shortDescription: "A boxed set of precision bearings for machines and convoy repairs.", flavorText: "Wrapped in oilcloth with forge batch marks.", sourceTags: ["trade", "industrial"] }),
  defineItem({ id: "blackharbor_pearl_casket", displayName: "Blackharbor Pearl Casket", category: "Trade Good", subtype: "Luxury Cargo", rarity: "rare", valueBuy: 500, valueSell: 230, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: ["blackharbor", "highcourt"], shortDescription: "A locked casket of pearls suited to premium resale and diplomacy.", flavorText: "The latch is plain; the contents are not.", sourceTags: ["trade", "luxury"] }),
  defineItem({ id: "silverbough_resin_cask", displayName: "Silverbough Resin Cask", category: "Trade Good", subtype: "Arcane Cargo", rarity: "uncommon", valueBuy: 280, valueSell: 128, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough", "highcourt"], shortDescription: "A sealed cask of resin used by healers, warders, and craft buyers.", flavorText: "Marked with a green seal and handling script.", sourceTags: ["trade", "arcane"] }),
  defineItem({ id: "nexis_permit_bundle", displayName: "Nexis Permit Bundle", category: "Trade Good", subtype: "Civic Paper", rarity: "common", valueBuy: 120, valueSell: 55, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "highcourt"], shortDescription: "Bundled permits used in civic contracts and legal supply runs.", flavorText: "Stamped, indexed, and tied with blue thread.", sourceTags: ["trade", "civic"] }),
  defineItem({ id: "foreign_clockwork_toy", displayName: "Foreign Clockwork Toy", category: "Collectible", subtype: "Curio", rarity: "uncommon", valueBuy: 210, valueSell: 96, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: ["blackharbor", "highcourt"], shortDescription: "A small imported clockwork curio valued by collectors and brokers.", flavorText: "It walks four steps and bows once when wound.", sourceTags: ["collectible", "import"] }),
  defineItem({ id: "academy_manuscript_copy", displayName: "Academy Manuscript Copy", category: "Trade Good", subtype: "Archive Copy", rarity: "uncommon", valueBuy: 170, valueSell: 78, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "highcourt", "silverbough"], shortDescription: "A copied academy manuscript used by students, archivists, and tutors.", flavorText: "Margins are clean, which makes it expensive.", sourceTags: ["trade", "academy"] }),
  defineItem({ id: "relic_appraisal_docket", displayName: "Relic Appraisal Docket", category: "Trade Good", subtype: "Relic Paper", rarity: "rare", valueBuy: 360, valueSell: 165, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough", "highcourt"], shortDescription: "A verified appraisal packet for relic lots and archive auctions.", flavorText: "Three signatures, two seals, one expensive opinion.", sourceTags: ["trade", "relic"] }),
  defineItem({ id: "merchants_sample_case", displayName: "Merchant's Sample Case", category: "Trade Good", subtype: "Market Sample", rarity: "uncommon", valueBuy: 230, valueSell: 105, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "blackharbor", "highcourt"], shortDescription: "A compact case of labeled samples for brokers and consortium buyers.", flavorText: "Tiny bottles, precise tags, formal invoice cards.", sourceTags: ["trade", "consortium"] }),
  defineItem({ id: "manual_clean_cuts", displayName: "Manual of Clean Cuts", category: "Manual", subtype: "Combat Manual", rarity: "rare", valueBuy: 600, valueSell: 275, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis"], requirements: { level: 5 }, shortDescription: "A rare manual for disciplined slashing technique and blade study.", flavorText: "Watch drills copied into tight civic script.", sourceTags: ["manual", "slashing", "rare-skill"] }),
  defineItem({ id: "piercers_chapbook", displayName: "Piercer's Chapbook", category: "Manual", subtype: "Combat Manual", rarity: "rare", valueBuy: 620, valueSell: 285, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: ["blackharbor"], requirements: { level: 5 }, shortDescription: "A compact manual for thrusting weapons, openings, and close quarters.", flavorText: "Water-stained pages, precise diagrams.", sourceTags: ["manual", "piercing", "rare-skill"] }),
  defineItem({ id: "bulwark_field_notes", displayName: "Bulwark Field Notes", category: "Manual", subtype: "Defense Manual", rarity: "rare", valueBuy: 680, valueSell: 315, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall"], requirements: { level: 10 }, shortDescription: "A rare manual for heavy armor positioning and blunt-force survival.", flavorText: "Every page smells faintly of oil and iron dust.", sourceTags: ["manual", "bludgeoning", "armor"] }),
  defineItem({ id: "smugglers_folded_route", displayName: "Smuggler's Folded Route", category: "Manual", subtype: "Covert Manual", rarity: "rare", valueBuy: 760, valueSell: 350, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: [], blackMarketAvailability: ["blackharbor"], requirements: { level: 10, courses: ["street-survival"] }, lockReasonText: "Requires Level 10 and Street Survival.", shortDescription: "A covert route manual for under-market movement and risky discoveries.", flavorText: "Folded so often the safe path is a crease.", sourceTags: ["manual", "covert", "travel"] }),
  defineItem({ id: "monster_trackers_slate", displayName: "Monster Tracker's Slate", category: "Manual", subtype: "Expedition Manual", rarity: "rare", valueBuy: 780, valueSell: 358, cityBias: "neutral", sourceCity: "neutral", legalMarketAvailability: ["nexis", "silverbough", "ironhall"], requirements: { level: 15 }, shortDescription: "A rare field manual for reading spoor, lairs, and elite hunt signs.", flavorText: "Etched marks survive mud, rain, and hurried hands.", sourceTags: ["manual", "expedition", "elite"] }),
  defineItem({ id: "siege_knot_folio", displayName: "Siege Knot Folio", category: "Manual", subtype: "Guild Manual", rarity: "rare", valueBuy: 820, valueSell: 377, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall", "blackharbor"], requirements: { level: 15 }, shortDescription: "A rare operations manual for ropes, braces, convoy defense, and breach work.", flavorText: "Each knot is drawn twice: once neat, once under stress.", sourceTags: ["manual", "guild", "operations"] }),

  defineItem({ id: "silverleaf", displayName: "Silverleaf", category: "Material", subtype: "Herb", rarity: "common", valueBuy: 30, valueSell: 14, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough"], shortDescription: "A common healing herb used in poultices and field medicines.", flavorText: "Pale leaves bruise into a clean scent.", sourceTags: ["material", "herb"] }),
  defineItem({ id: "aether_thread", displayName: "Aether Thread", category: "Material", subtype: "Arcane Fiber", rarity: "uncommon", valueBuy: 92, valueSell: 42, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough", "highcourt"], shortDescription: "A fine thread used in warded clothing and focus bindings.", flavorText: "Almost weightless, difficult to knot.", sourceTags: ["material", "arcane"] }),
  defineItem({ id: "black_salt", displayName: "Black Salt", category: "Material", subtype: "Covert Reagent", rarity: "uncommon", valueBuy: 86, valueSell: 39, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: [], blackMarketAvailability: ["blackharbor"], requirements: { courses: ["street-survival"] }, lockReasonText: "Requires Street Survival and under-market access.", shortDescription: "A covert reagent used in smoke charges, inks, and route tricks.", flavorText: "Dark grains packed in sealed wax paper.", sourceTags: ["material", "covert"] }),
  defineItem({ id: "brass_gearplate", displayName: "Brass Gearplate", category: "Material", subtype: "Mechanical Part", rarity: "common", valueBuy: 48, valueSell: 22, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall"], shortDescription: "A flat brass component used in tools, clocks, and enginewright repairs.", flavorText: "Cut clean and stamped with batch marks.", sourceTags: ["material", "enginewright"] }),
  defineItem({ id: "moon_resin", displayName: "Moon Resin", category: "Material", subtype: "Arcane Resin", rarity: "rare", valueBuy: 180, valueSell: 81, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough"], shortDescription: "A rare resin used in premium foci, wards, and court curios.", flavorText: "Cloudy at dawn, clear under moonlight.", sourceTags: ["material", "rare"] }),
  defineItem({ id: "court_parchment", displayName: "Court Parchment", category: "Material", subtype: "Document Stock", rarity: "common", valueBuy: 40, valueSell: 18, cityBias: "highcourt", sourceCity: "highcourt", legalMarketAvailability: ["highcourt", "nexis"], shortDescription: "Formal parchment used in writs, petitions, and legal records.", flavorText: "Smooth enough for seals, heavy enough for consequence.", sourceTags: ["material", "legal"] }),
  defineItem({ id: "rivet_chain", displayName: "Rivet Chain", category: "Material", subtype: "Forge Component", rarity: "common", valueBuy: 56, valueSell: 25, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall"], shortDescription: "Linked forge stock used in armor repairs and route equipment.", flavorText: "Each link is square-set and heat checked.", sourceTags: ["material", "forge"] }),
  defineItem({ id: "grove_amber", displayName: "Grove Amber", category: "Material", subtype: "Relic Resin", rarity: "uncommon", valueBuy: 108, valueSell: 49, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough", "highcourt"], shortDescription: "Amber used for relic appraisal, ward fittings, and prestige craft.", flavorText: "Small motes hang inside like trapped lamplight.", sourceTags: ["material", "relic"] }),

  defineItem({ id: "guard_whistle", displayName: "Guard Whistle", category: "Tool", subtype: "Civic Tool", rarity: "common", valueBuy: 42, valueSell: 19, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "highcourt"], passiveEffects: { civicPaperwork: 1 }, shortDescription: "A civic tool used by patrol aides, escorts, and contract runners.", flavorText: "A clear note carries farther than a shouted report.", sourceTags: ["tool", "civic"] }),
  defineItem({ id: "appraiser_lens", displayName: "Appraiser Lens", category: "Tool", subtype: "Market Tool", rarity: "uncommon", valueBuy: 142, valueSell: 64, cityBias: "highcourt", sourceCity: "highcourt", legalMarketAvailability: ["highcourt", "nexis"], passiveEffects: { appraisal: 1 }, shortDescription: "A small lens for judging relics, gems, and market lots.", flavorText: "Good glass makes bad bargains easier to see.", sourceTags: ["tool", "market"] }),
  defineItem({ id: "portable_anvil_plate", displayName: "Portable Anvil Plate", category: "Tool", subtype: "Forge Tool", rarity: "uncommon", valueBuy: 156, valueSell: 70, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall"], statModifiers: { workingStats: { manualLabor: 1 } }, passiveEffects: { repairQuality: 1 }, shortDescription: "A heavy field plate for repairs, rivets, and expedition maintenance.", flavorText: "Small by anvil standards, which still means heavy.", sourceTags: ["tool", "repair"] }),
  defineItem({ id: "cartographer_pins", displayName: "Cartographer Pins", category: "Tool", subtype: "Travel Tool", rarity: "common", valueBuy: 66, valueSell: 30, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "highcourt"], passiveEffects: { travelClarity: 1 }, shortDescription: "Marked pins for route planning, discoveries, and caravan notes.", flavorText: "Color-coded by danger, distance, and delay.", sourceTags: ["tool", "travel"] }),
  defineItem({ id: "surveyors_chalkline", displayName: "Surveyor's Chalkline", category: "Tool", subtype: "Field Tool", rarity: "common", valueBuy: 60, valueSell: 27, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall", "nexis"], passiveEffects: { discoveryQuality: 1 }, shortDescription: "A measuring line used in ruins, roadwork, and hidden-site surveys.", flavorText: "A straight line is still useful in a crooked place.", sourceTags: ["tool", "survey"] }),
  defineItem({ id: "locksmith_tension_kit", displayName: "Locksmith Tension Kit", category: "Tool", subtype: "Covert Tool", rarity: "uncommon", valueBuy: 124, valueSell: 56, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: [], blackMarketAvailability: ["blackharbor"], requirements: { courses: ["street-survival"] }, lockReasonText: "Requires Street Survival and under-market access.", shortDescription: "A compact kit for covert locks, sealed crates, and quiet entries.", flavorText: "Every pick sits in a narrow stitched channel.", sourceTags: ["tool", "covert"] }),
  defineItem({ id: "mercy_needle_kit", displayName: "Mercy Needle Kit", category: "Tool", subtype: "Medical Tool", rarity: "uncommon", valueBuy: 138, valueSell: 62, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough"], passiveEffects: { healingBonus: 0.03 }, shortDescription: "A healer's needle kit for careful field treatment and clinic work.", flavorText: "Thin steel, clean thread, steady hands.", sourceTags: ["tool", "medical"] }),
  defineItem({ id: "brokers_abacus", displayName: "Broker's Abacus", category: "Tool", subtype: "Market Tool", rarity: "uncommon", valueBuy: 150, valueSell: 68, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: ["blackharbor", "highcourt"], passiveEffects: { sellBonusPercent: 1 }, shortDescription: "A compact abacus for pricing cargo, margins, and trade listings.", flavorText: "The beads move quickly under practiced fingers.", sourceTags: ["tool", "market"] }),

  defineItem({ id: "barbed_caltrops", displayName: "Barbed Caltrops", category: "Consumable", subtype: "Temporary", rarity: "common", valueBuy: 64, valueSell: 29, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall", "nexis"], useEffects: [{ type: "combat_buff", effect: "evadeBonus", amount: 4, context: "combat", uses: 1 }], shortDescription: "A throw-down hazard used to control footwork for one fight.", flavorText: "Small iron teeth packed in a stiff pouch.", sourceTags: ["temporary", "control"] }),
  defineItem({ id: "flash_powder", displayName: "Flash Powder", category: "Consumable", subtype: "Temporary", rarity: "uncommon", valueBuy: 96, valueSell: 43, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: [], blackMarketAvailability: ["blackharbor", "highcourt"], useEffects: [{ type: "combat_buff", effect: "evadeBonus", amount: 8, context: "combat", uses: 1 }], requirements: { courses: ["street-survival"] }, lockReasonText: "Requires Street Survival and under-market access.", shortDescription: "A covert flash charge that improves evasion for one fight.", flavorText: "Paper-wrapped powder marked with a single black line.", sourceTags: ["temporary", "covert"] }),
  defineItem({ id: "glass_net_vial", displayName: "Glass Net Vial", category: "Consumable", subtype: "Temporary", rarity: "uncommon", valueBuy: 118, valueSell: 53, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough"], useEffects: [{ type: "combat_buff", effect: "accuracyBonus", amount: 6, context: "combat", uses: 1 }], shortDescription: "A brittle vial that breaks into slowing filaments before a strike.", flavorText: "The glass is scored so it fails exactly once.", sourceTags: ["temporary", "arcane"] }),
  defineItem({ id: "tar_snare_pot", displayName: "Tar Snare Pot", category: "Consumable", subtype: "Temporary", rarity: "common", valueBuy: 72, valueSell: 32, cityBias: "blackharbor", sourceCity: "blackharbor", legalMarketAvailability: ["blackharbor"], useEffects: [{ type: "combat_buff", effect: "accuracyBonus", amount: 5, context: "combat", uses: 1 }], shortDescription: "A sticky snare pot used to slow a target's movement for one fight.", flavorText: "Sealed tight enough to survive a wet dock run.", sourceTags: ["temporary", "maritime"] }),
  defineItem({ id: "nullsalt_pouch", displayName: "Nullsalt Pouch", category: "Consumable", subtype: "Temporary", rarity: "rare", valueBuy: 210, valueSell: 95, cityBias: "highcourt", sourceCity: "highcourt", legalMarketAvailability: ["highcourt"], useEffects: [{ type: "combat_buff", effect: "mitigationBonus", amount: 0.08, context: "combat", uses: 1 }], shortDescription: "A rare warded salt pouch that reduces incoming pressure for one fight.", flavorText: "Court mages sign the packet before sealing it.", sourceTags: ["temporary", "rare", "ward"] }),
  defineItem({ id: "ember_oil", displayName: "Ember Oil", category: "Consumable", subtype: "Weapon Oil", rarity: "uncommon", valueBuy: 106, valueSell: 48, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall"], useEffects: [{ type: "combat_buff", effect: "critBonus", amount: 5, context: "combat", uses: 1 }], shortDescription: "A forge oil that improves critical pressure for one fight.", flavorText: "Warm even after the lamp goes out.", sourceTags: ["temporary", "weapon-oil"] }),
  defineItem({ id: "venomward_chew", displayName: "Venomward Chew", category: "Consumable", subtype: "Antidote", rarity: "common", valueBuy: 54, valueSell: 24, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough", "blackharbor"], useEffects: [{ type: "combat_buff", effect: "mitigationBonus", amount: 0.03, context: "combat", uses: 1 }], shortDescription: "A bitter chew used before poison-heavy fights.", flavorText: "Wrapped in reed paper and labeled by dose.", sourceTags: ["poison", "support"] }),

  defineItem({ id: "sutured_field_roll", displayName: "Sutured Field Roll", category: "Consumable", subtype: "Medical", rarity: "common", valueBuy: 38, valueSell: 17, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "silverbough"], useEffects: [{ type: "restore_health", amount: 24, context: "combat_or_field" }], shortDescription: "A compact medical roll for closing cuts and stabilizing travel wounds.", flavorText: "Clean thread, firm cloth, and no wasted space.", sourceTags: ["medical", "field", "support"] }),
  defineItem({ id: "silverleaf_poultice", displayName: "Silverleaf Poultice", category: "Consumable", subtype: "Medical", rarity: "common", valueBuy: 44, valueSell: 20, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough", "nexis"], useEffects: [{ type: "restore_health", amount: 28, context: "combat_or_field" }], shortDescription: "A pressed herb poultice for quick field recovery.", flavorText: "Wrapped in waxed leaf and tied with plain twine.", sourceTags: ["medical", "herb"] }),
  defineItem({ id: "bloodroot_draught", displayName: "Bloodroot Draught", category: "Consumable", subtype: "Medical", rarity: "uncommon", valueBuy: 118, valueSell: 53, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough"], useEffects: [{ type: "restore_health", amount: 58, context: "combat_or_field" }], shortDescription: "A potent healing draught for deep wounds and elite expedition recovery.", flavorText: "Dark red medicine sealed under green wax.", sourceTags: ["medical", "elite-supply"] }),
  defineItem({ id: "wakewater_ampoule", displayName: "Wakewater Ampoule", category: "Consumable", subtype: "Focus", rarity: "uncommon", valueBuy: 104, valueSell: 47, cityBias: "highcourt", sourceCity: "highcourt", legalMarketAvailability: ["highcourt", "nexis"], useEffects: [{ type: "restore_energy", amount: 30, context: "field" }], shortDescription: "A refined ampoule that restores energy for study, travel, or operations.", flavorText: "Clear liquid in a narrow court glass tube.", sourceTags: ["booster", "focus"] }),
  defineItem({ id: "roadside_meal", displayName: "Roadside Meal", category: "Consumable", subtype: "Food", rarity: "common", valueBuy: 22, valueSell: 10, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "blackharbor", "ironhall"], useEffects: [{ type: "restore_energy", amount: 12, context: "field" }], shortDescription: "A simple meal packed for work shifts and short routes.", flavorText: "Bread, dried fruit, and enough salt to keep moving.", sourceTags: ["food", "travel"] }),
  defineItem({ id: "ember_coffee", displayName: "Ember Coffee", category: "Consumable", subtype: "Drink", rarity: "common", valueBuy: 48, valueSell: 21, cityBias: "ironhall", sourceCity: "ironhall", legalMarketAvailability: ["ironhall", "nexis"], useEffects: [{ type: "restore_energy", amount: 20, context: "field" }], shortDescription: "A strong hot drink for workshop shifts and early departures.", flavorText: "Roasted dark enough to hold a forgeworker's attention.", sourceTags: ["drink", "energy"] }),
  defineItem({ id: "moonmilk_cordial", displayName: "Moonmilk Cordial", category: "Consumable", subtype: "Cordial", rarity: "rare", valueBuy: 190, valueSell: 86, cityBias: "silverbough", sourceCity: "silverbough", legalMarketAvailability: ["silverbough"], useEffects: [{ type: "restore_health", amount: 46, context: "field" }, { type: "restore_energy", amount: 24, context: "field" }], shortDescription: "A rare cordial that restores health and focus between dangerous runs.", flavorText: "Pale liquid with a quiet silver sheen.", sourceTags: ["rare", "cordial", "support"] }),
  defineItem({ id: "rally_salt", displayName: "Rally Salt", category: "Consumable", subtype: "Battle Supply", rarity: "common", valueBuy: 58, valueSell: 26, cityBias: "nexis", sourceCity: "nexis", legalMarketAvailability: ["nexis", "ironhall"], useEffects: [{ type: "combat_buff", effect: "accuracyBonus", amount: 4, context: "combat", uses: 1 }], shortDescription: "A sharp battlefield salt that improves accuracy for one fight.", flavorText: "Carried by watch sergeants and tired caravan guards.", sourceTags: ["temporary", "combat-support"] }),
];


const EXCURSION_DISCOVERY_ITEMS = [
  defineItem({ id: "registry_brass", displayName: "Registry Brass", category: "Material", subtype: "Civic Metal", rarity: "uncommon", valueBuy: 90, valueSell: 41, cityBias: "nexis", sourceCity: "nexis", shortDescription: "Civic brass recovered from old registry locks and watch fittings.", flavorText: "Stamped with small ledger marks.", sourceTags: ["excursion", "crafting", "civic"] }),
  defineItem({ id: "watchglass_shard", displayName: "Watchglass Shard", category: "Material", subtype: "Civic Glass", rarity: "epic", valueBuy: 360, valueSell: 162, cityBias: "nexis", sourceCity: "nexis", shortDescription: "Dense watchglass used in high-grade civic armor plates.", flavorText: "Blue light catches along its edge.", sourceTags: ["excursion", "recipe", "epic"] }),
  defineItem({ id: "watchglass_aegis_piece", displayName: "Watchglass Aegis Piece", category: "Material", subtype: "Armor Fragment", rarity: "rare", valueBuy: 260, valueSell: 117, cityBias: "nexis", sourceCity: "nexis", shortDescription: "A shaped fragment from an old civic defense harness.", flavorText: "Its rivet holes still line up cleanly.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "watchglass_aegis_plate", displayName: "Watchglass Aegis Plate", category: "Material", subtype: "Epic Component", rarity: "epic", valueBuy: 720, valueSell: 324, cityBias: "nexis", sourceCity: "nexis", shortDescription: "An epic civic plate prepared for watch armor and shield work.", flavorText: "Filed smooth and ready for setting.", sourceTags: ["crafted", "epic", "armor-component"] }),
  defineItem({ id: "concordant_shard", displayName: "Concordant Shard", category: "Material", subtype: "Balanced Relic", rarity: "legendary", valueBuy: 980, valueSell: 441, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A balanced relic shard used in Concordant pattern work.", flavorText: "It weighs the same whichever way it is held.", sourceTags: ["excursion", "legendary"] }),
  defineItem({ id: "concordant_pattern_plate", displayName: "Concordant Pattern Plate", category: "Material", subtype: "Legendary Component", rarity: "legendary", valueBuy: 1800, valueSell: 810, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A legendary plate etched for all-round defensive patterning.", flavorText: "Five lines meet without crossing.", sourceTags: ["crafted", "legendary", "concordant"] }),
  defineItem({ id: "concordant_aegis_fragment", displayName: "Concordant Aegis Fragment", category: "Material", subtype: "Armor Fragment", rarity: "rare", valueBuy: 520, valueSell: 234, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A fragment that may belong to an older Concordant harness.", flavorText: "The surface keeps a dull silver tone.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "saltsteel_flake", displayName: "Saltsteel Flake", category: "Material", subtype: "Maritime Metal", rarity: "epic", valueBuy: 330, valueSell: 149, cityBias: "blackharbor", sourceCity: "blackharbor", shortDescription: "A corrosion-hard flake used in maritime bindings and covert gear.", flavorText: "Salt crystals cling to the grain.", sourceTags: ["excursion", "epic", "blackharbor"] }),
  defineItem({ id: "saltsteel_binding", displayName: "Saltsteel Binding", category: "Material", subtype: "Epic Component", rarity: "epic", valueBuy: 690, valueSell: 311, cityBias: "blackharbor", sourceCity: "blackharbor", shortDescription: "An epic binding for corsair fittings, hidden cases, and sea gear.", flavorText: "The clamp seals without bright polish.", sourceTags: ["crafted", "epic", "maritime"] }),
  defineItem({ id: "corsair_relic_piece", displayName: "Corsair Relic Piece", category: "Material", subtype: "Gear Fragment", rarity: "rare", valueBuy: 280, valueSell: 126, cityBias: "blackharbor", sourceCity: "blackharbor", shortDescription: "A marked relic piece from old Blackharbor deck gear.", flavorText: "Cut with a private tide mark.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "blackwake_edge_piece", displayName: "Blackwake Edge Piece", category: "Material", subtype: "Blade Fragment", rarity: "rare", valueBuy: 430, valueSell: 194, cityBias: "blackharbor", sourceCity: "blackharbor", shortDescription: "A dark blade fragment recovered from wreck routes.", flavorText: "The edge remains narrow and clean.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "blackwake_keelmark", displayName: "Blackwake Keelmark", category: "Material", subtype: "Legendary Component", rarity: "legendary", valueBuy: 1500, valueSell: 675, cityBias: "blackharbor", sourceCity: "blackharbor", shortDescription: "A legendary keelmark used in high-grade maritime weapon work.", flavorText: "Tar-dark lines run through the metal.", sourceTags: ["crafted", "legendary", "maritime"] }),
  defineItem({ id: "wardglass_splinter", displayName: "Wardglass Splinter", category: "Material", subtype: "Arcane Glass", rarity: "epic", valueBuy: 345, valueSell: 155, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "An arcane glass splinter used in ward cores and focus work.", flavorText: "It rings softly near old charms.", sourceTags: ["excursion", "epic", "ward"] }),
  defineItem({ id: "moonward_core", displayName: "Moonward Core", category: "Material", subtype: "Epic Component", rarity: "epic", valueBuy: 760, valueSell: 342, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "An epic ward core prepared from resin, glass, and woven aether.", flavorText: "A pale line circles the center.", sourceTags: ["crafted", "epic", "ward"] }),
  defineItem({ id: "argent_focus_piece", displayName: "Argent Focus Piece", category: "Material", subtype: "Focus Fragment", rarity: "rare", valueBuy: 460, valueSell: 207, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "A bright focus fragment from a highland survey site.", flavorText: "Its corners are etched with measure marks.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "argent_spire_focus", displayName: "Argent Spire Focus", category: "Material", subtype: "Legendary Component", rarity: "legendary", valueBuy: 1660, valueSell: 747, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "A legendary focus core aligned to old survey geometry.", flavorText: "The inner ring holds steady under pressure.", sourceTags: ["crafted", "legendary", "focus"] }),
  defineItem({ id: "furnace_thread", displayName: "Furnace Thread", category: "Material", subtype: "Forge Fiber", rarity: "epic", valueBuy: 340, valueSell: 153, cityBias: "ironhall", sourceCity: "ironhall", shortDescription: "Heat-treated fiber used in advanced forge braces and armor seams.", flavorText: "Dark strands hold a copper sheen.", sourceTags: ["excursion", "epic", "forge"] }),
  defineItem({ id: "furnace_threaded_brace", displayName: "Furnace-Threaded Brace", category: "Material", subtype: "Epic Component", rarity: "epic", valueBuy: 710, valueSell: 320, cityBias: "ironhall", sourceCity: "ironhall", shortDescription: "An epic brace reinforced with furnace thread and rivet stock.", flavorText: "It flexes slightly, then locks hard.", sourceTags: ["crafted", "epic", "forge"] }),
  defineItem({ id: "bulwark_rivet_piece", displayName: "Bulwark Rivet Piece", category: "Material", subtype: "Armor Fragment", rarity: "rare", valueBuy: 300, valueSell: 135, cityBias: "ironhall", sourceCity: "ironhall", shortDescription: "A heavy rivet fragment from old bulwark armor.", flavorText: "Still blackened from forge heat.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "anvilheart_frame_piece", displayName: "Anvilheart Frame Piece", category: "Material", subtype: "Frame Fragment", rarity: "rare", valueBuy: 500, valueSell: 225, cityBias: "ironhall", sourceCity: "ironhall", shortDescription: "A frame fragment from a failed heavy engine harness.", flavorText: "Stamped with an incomplete furnace mark.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "anvilheart_frame", displayName: "Anvilheart Frame", category: "Material", subtype: "Legendary Component", rarity: "legendary", valueBuy: 1700, valueSell: 765, cityBias: "ironhall", sourceCity: "ironhall", shortDescription: "A legendary frame for heavy armor and reinforced weapon housings.", flavorText: "It settles like a tool that knows its work.", sourceTags: ["crafted", "legendary", "forge"] }),
  defineItem({ id: "oathglass_splinter", displayName: "Oathglass Splinter", category: "Material", subtype: "Court Glass", rarity: "epic", valueBuy: 350, valueSell: 158, cityBias: "highcourt", sourceCity: "highcourt", shortDescription: "A formal glass splinter used in writ seals and court bindings.", flavorText: "Its surface holds a faint stamp line.", sourceTags: ["excursion", "epic", "court"] }),
  defineItem({ id: "oathglass_seal", displayName: "Oathglass Seal", category: "Material", subtype: "Epic Component", rarity: "epic", valueBuy: 735, valueSell: 331, cityBias: "highcourt", sourceCity: "highcourt", shortDescription: "An epic seal prepared for authority gear and binding work.", flavorText: "The wax catches cleanly along the glass rim.", sourceTags: ["crafted", "epic", "court"] }),
  defineItem({ id: "bastion_writ_piece", displayName: "Bastion Writ Piece", category: "Material", subtype: "Armor Fragment", rarity: "rare", valueBuy: 470, valueSell: 212, cityBias: "highcourt", sourceCity: "highcourt", shortDescription: "A sealed writ fragment from old Highcourt bastion gear.", flavorText: "The signature is intact, the context is not.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "bastion_writwork", displayName: "Bastion Writwork", category: "Material", subtype: "Legendary Component", rarity: "legendary", valueBuy: 1640, valueSell: 738, cityBias: "highcourt", sourceCity: "highcourt", shortDescription: "Legendary writwork for prestige armor, seals, and warded authority pieces.", flavorText: "Every line is ruled in formal gold ink.", sourceTags: ["crafted", "legendary", "court"] }),
  defineItem({ id: "absolute_ink", displayName: "Absolute Ink", category: "Material", subtype: "Mythic Ink", rarity: "legendary", valueBuy: 900, valueSell: 405, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A dark archival ink tied to fragments of the Absolute story.", flavorText: "It dries without losing depth.", sourceTags: ["excursion", "absolute", "recipe"] }),
  defineItem({ id: "absolute_story_fragment", displayName: "Absolute Story Fragment", category: "Collectible", subtype: "Story Fragment", rarity: "mythic", valueBuy: 1200, valueSell: 540, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A mythic story fragment connected to the Absolute's buried record.", flavorText: "A single line survives on darkened vellum.", sourceTags: ["excursion", "absolute", "mythic"] }),
  defineItem({ id: "absolute_script_leaf", displayName: "Absolute Script Leaf", category: "Collectible", subtype: "Mythic Record", rarity: "mythic", valueBuy: 5000, valueSell: 2250, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A mythic bound leaf made from recovered Absolute script fragments.", flavorText: "The page remains warm after reading.", sourceTags: ["crafted", "absolute", "mythic"] }),
  defineItem({ id: "absolute_relic_shard", displayName: "Absolute Relic Shard", category: "Material", subtype: "Mythic Fragment", rarity: "mythic", valueBuy: 2400, valueSell: 1080, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A mythic shard linked to older Absolute relic work.", flavorText: "Its edge reflects more than the room around it.", sourceTags: ["excursion", "item-piece", "mythic"] }),
  defineItem({ id: "sunmetal_grit", displayName: "Sunmetal Grit", category: "Material", subtype: "Desert Metal", rarity: "legendary", valueBuy: 780, valueSell: 351, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A bright metal grit used in red-sand tempering work.", flavorText: "The grains keep a dry gold shine.", sourceTags: ["excursion", "legendary"] }),
  defineItem({ id: "redsand_edge_piece", displayName: "Redsand Edge Piece", category: "Material", subtype: "Blade Fragment", rarity: "rare", valueBuy: 430, valueSell: 194, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A blade fragment with red-sand temper marks.", flavorText: "The bevel is narrow and heat-stained.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "redsand_tempering_salts", displayName: "Redsand Tempering Salts", category: "Material", subtype: "Legendary Component", rarity: "legendary", valueBuy: 1460, valueSell: 657, cityBias: "neutral", sourceCity: "neutral", shortDescription: "Legendary salts used for high-heat blade tempering.", flavorText: "They settle in clean red layers.", sourceTags: ["crafted", "legendary"] }),
  defineItem({ id: "blueglass_splinter", displayName: "Blueglass Splinter", category: "Material", subtype: "Navigation Glass", rarity: "epic", valueBuy: 330, valueSell: 149, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A sea-blue splinter used in route lenses and signal craft.", flavorText: "It clears under open sky.", sourceTags: ["excursion", "epic"] }),
  defineItem({ id: "blueglass_lens_piece", displayName: "Blueglass Lens Piece", category: "Material", subtype: "Lens Fragment", rarity: "rare", valueBuy: 360, valueSell: 162, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A lens fragment recovered from old signal cairns.", flavorText: "The curve is still precise.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "blueglass_navigation_lens", displayName: "Blueglass Navigation Lens", category: "Tool", subtype: "Epic Route Tool", rarity: "epic", valueBuy: 820, valueSell: 369, cityBias: "neutral", sourceCity: "neutral", passiveEffects: { travelClarity: 2 }, shortDescription: "An epic route lens that improves survey and navigation reads.", flavorText: "It catches coastlines before the eye does.", sourceTags: ["crafted", "epic", "travel"] }),
  defineItem({ id: "cold_iron_scale", displayName: "Cold Iron Scale", category: "Material", subtype: "Frozen Metal", rarity: "legendary", valueBuy: 860, valueSell: 387, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "A cold-worked scale used in frostward laminates.", flavorText: "Frost gathers along its lower edge.", sourceTags: ["excursion", "legendary"] }),
  defineItem({ id: "frostward_scale_piece", displayName: "Frostward Scale Piece", category: "Material", subtype: "Armor Fragment", rarity: "rare", valueBuy: 460, valueSell: 207, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "A frozen scale fragment from old pass armor.", flavorText: "Its surface stays dry in the hand.", sourceTags: ["excursion", "item-piece"] }),
  defineItem({ id: "frostward_laminate", displayName: "Frostward Laminate", category: "Material", subtype: "Legendary Component", rarity: "legendary", valueBuy: 1680, valueSell: 756, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "A legendary laminate for cold, warded, and arcane defensive craft.", flavorText: "Thin layers hold a pale blue line.", sourceTags: ["crafted", "legendary", "ward"] }),
  defineItem({ id: "crowlantern_smoke_charge", displayName: "Crowlantern Smoke Charge", category: "Consumable", subtype: "Epic Covert Supply", rarity: "epic", valueBuy: 520, valueSell: 234, cityBias: "blackharbor", sourceCity: "blackharbor", useEffects: [{ type: "combat_buff", effect: "evadeBonus", amount: 10, context: "combat", uses: 1 }], shortDescription: "An epic smoke charge for one dangerous covert fight.", flavorText: "A black wick is folded under the cap.", sourceTags: ["crafted", "epic", "covert"] }),
  defineItem({ id: "registry_glass_index", displayName: "Registry Glass Index", category: "Tool", subtype: "Epic Archive Tool", rarity: "epic", valueBuy: 880, valueSell: 396, cityBias: "nexis", sourceCity: "nexis", passiveEffects: { discoveryQuality: 2 }, shortDescription: "An epic index lens for archive doors, civic puzzles, and hidden records.", flavorText: "The frame is numbered on both sides.", sourceTags: ["crafted", "epic", "archive"] }),
  defineItem({ id: "skill_manual_fragment", displayName: "Skill Manual Fragment", category: "Manual", subtype: "Fragment", rarity: "rare", valueBuy: 180, valueSell: 81, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A fragment of a practical skill manual; ten matching fragments form a full manual.", flavorText: "A partial drill diagram fills the margin.", sourceTags: ["excursion", "fragment", "skill"] }),
  defineItem({ id: "spell_text_fragment", displayName: "Spell Text Fragment", category: "Manual", subtype: "Magic Fragment", rarity: "rare", valueBuy: 220, valueSell: 99, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A fragment of a spell text; ten matching fragments form a bound spellbook.", flavorText: "The script holds a faint line of light.", sourceTags: ["excursion", "fragment", "magic"] }),
  defineItem({ id: "compiled_skill_manual", displayName: "Compiled Skill Manual", category: "Manual", subtype: "Completed Manual", rarity: "epic", valueBuy: 900, valueSell: 405, cityBias: "neutral", sourceCity: "neutral", requirements: { level: 5 }, shortDescription: "A completed skill manual assembled from ten excursion fragments.", flavorText: "Bound for study rather than display.", sourceTags: ["excursion", "book", "skill"] }),
  defineItem({ id: "bound_spellbook", displayName: "Bound Spellbook", category: "Manual", subtype: "Completed Spellbook", rarity: "epic", valueBuy: 1100, valueSell: 495, cityBias: "neutral", sourceCity: "neutral", requirements: { level: 5 }, shortDescription: "A completed spellbook assembled from ten excursion fragments.", flavorText: "The binding settles when closed.", sourceTags: ["excursion", "book", "magic"] }),
  defineItem({ id: "watch_drill_book", displayName: "Watch Drill Book", category: "Manual", subtype: "Training Book", rarity: "rare", valueBuy: 480, valueSell: 216, cityBias: "nexis", sourceCity: "nexis", shortDescription: "A training book for civic patrol forms and disciplined blade work.", flavorText: "Copied in square watch-house script.", sourceTags: ["excursion", "training"] }),
  defineItem({ id: "dockside_training_book", displayName: "Dockside Training Book", category: "Manual", subtype: "Training Book", rarity: "rare", valueBuy: 500, valueSell: 225, cityBias: "blackharbor", sourceCity: "blackharbor", shortDescription: "A training book for dock movement, covert timing, and cargo fights.", flavorText: "The cover is waxed against salt air.", sourceTags: ["excursion", "training"] }),
  defineItem({ id: "grove_field_book", displayName: "Grove Field Book", category: "Manual", subtype: "Training Book", rarity: "rare", valueBuy: 520, valueSell: 234, cityBias: "silverbough", sourceCity: "silverbough", shortDescription: "A training book for ward paths, field herbs, and shrine safety.", flavorText: "Pressed leaves mark three chapters.", sourceTags: ["excursion", "training"] }),
  defineItem({ id: "forge_training_book", displayName: "Forge Training Book", category: "Manual", subtype: "Training Book", rarity: "rare", valueBuy: 540, valueSell: 243, cityBias: "ironhall", sourceCity: "ironhall", shortDescription: "A training book for bracework, heavy tools, and forge-road readiness.", flavorText: "The spine is reinforced with rivets.", sourceTags: ["excursion", "training"] }),
  defineItem({ id: "court_training_book", displayName: "Court Training Book", category: "Manual", subtype: "Training Book", rarity: "rare", valueBuy: 560, valueSell: 252, cityBias: "highcourt", sourceCity: "highcourt", shortDescription: "A training book for writ handling, formal defense, and court routes.", flavorText: "Each page carries a neat lower seal.", sourceTags: ["excursion", "training"] }),
  defineItem({ id: "waste_survival_book", displayName: "Waste Survival Book", category: "Manual", subtype: "Training Book", rarity: "rare", valueBuy: 620, valueSell: 279, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A training book for desert routes, ration discipline, and heat signs.", flavorText: "Sand sits deep in the binding.", sourceTags: ["excursion", "training"] }),
  defineItem({ id: "route_training_book", displayName: "Route Training Book", category: "Manual", subtype: "Training Book", rarity: "rare", valueBuy: 600, valueSell: 270, cityBias: "neutral", sourceCity: "neutral", shortDescription: "A training book for reading distance, signal cairns, and difficult routes.", flavorText: "The diagrams use blue coast ink.", sourceTags: ["excursion", "training"] }),
];
...
const RAW_ITEMS = [...CORE_ITEMS, ...ACADEMY_ITEMS, ...EXTRA_ITEMS, ...INSPIRATION_PASS_ITEMS, ...EXCURSION_DISCOVERY_ITEMS, ...ITEMIZATION_PASS_ITEMS];
...
export function getItemAcquisitionPaths(item) {
  ...
  if (definition.category === "Manual") paths.push({ category: "Manual / Book", label: `${city} manual source`, detail: "Manuals enter the world through discoveries, academy archives, elite drops, board rumors, black-market routes, and player listings." });
  if (definition.category === "Tool") paths.push({ category: "Tool", label: `${city} utility source`, detail: "Tools appear through city shops, crafting loops, contract rewards, and player-market listings." });
  if (["Collectible", "Jewelry"].includes(definition.category)) paths.push({ category: "General Shopping", label: `${city} collector source`, detail: "Collector goods circulate through city markets, travel finds, prestige rewards, and player listings." });
  ...
  if (["rare", "epic", "legendary", "mythic"].includes(definition.rarity)) paths.push({ category: definition.rarity === "mythic" ? "Mythic Lead" : definition.rarity === "legendary" ? "Legendary Lead" : definition.rarity === "epic" ? "Epic Lead" : "Rare Lead", label: "Excursion or elite source", detail: "Higher-rarity items are aimed at excursions, elite hunts, hidden-site runs, board rumors, and player-market circulation." });
